...
Benchmarking methodology — `benchstat`, profiling, noise control, and regression detection — belongs to the local `go-performance` skill. This page only covers writing a benchmark that sits next to the tests of the same package.
...
Use `go-performance` for measurement methodology and regression detection.
