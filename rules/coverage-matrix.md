...
Suffix matchers require a DNS label boundary. HTTP rules consume retained, sanitized headers and script URLs. Rules compile at bundle load and cannot execute code or make requests.

Positive fixtures must assert subject, scope, relation, provider or product specificity, and evidence references. Negative fixtures must reject the unsupported conclusion. The [specification](../SPEC.md#85-product-and-relationship-acceptance-matrix) defines the required matrix; the [qualification report](../docs/qualification.md#controlled-corpus-results) records measured fixture results.
